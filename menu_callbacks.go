...
func renderFeatureMenu(key string, userID int64) (string, tgbotapi.InlineKeyboardMarkup) {
	...
	case "sect":
		rows := [][]tgbotapi.InlineKeyboardButton{
			...
			menuCmdRow("📝 我的宗门任务", "my_sect_tasks"),
			...
			menuCmdRow("📚 藏经阁", "sect_library"),
			menuCmdRow("🔮 护宗神兽", "sect_beast"),
			menuCmdRow("🔮 宗门运势", "sect_fortune"),
	...
	case "assets":
		return "🧾 **【资产交易】**", menuMarkup(
			...
			menuCmdRow("♻️ 卡密回收", "code_cashout"),
