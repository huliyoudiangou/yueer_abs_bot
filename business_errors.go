...
var (
	...
	errSectManualNotFound             = errors.New("SECT_MANUAL_NOT_FOUND")
	errSectManualAlreadyUnlocked      = errors.New("SECT_MANUAL_ALREADY_UNLOCKED")
	errSectManualNotUnlocked          = errors.New("SECT_MANUAL_NOT_UNLOCKED")
	errSectManualLibraryLevelLow      = errors.New("SECT_LIBRARY_LEVEL_LOW")
	errSectManualServantQualityLow    = errors.New("SECT_MANUAL_SERVANT_QUALITY_LOW")
	errSectManualAlreadyStudying      = errors.New("SECT_MANUAL_ALREADY_STUDYING")
	errSectManualNotStudied           = errors.New("SECT_MANUAL_NOT_STUDIED")
	errSectManualMaxDepth             = errors.New("SECT_MANUAL_MAX_DEPTH")
	errSectManualDepthChanged         = errors.New("SECT_MANUAL_DEPTH_CHANGED")
	errSectManualServantNotOwned      = errors.New("SECT_MANUAL_SERVANT_NOT_OWNED")
	errSectFortuneDailyLimit          = errors.New("SECT_FORTUNE_DAILY_LIMIT")
	errSectFortuneConcurrent          = errors.New("SECT_FORTUNE_CONCURRENT")
